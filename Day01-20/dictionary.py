...
# 成员运算
# 字典使用 in 进行成员判断时，默认检查的是“键”，不是值
print('name' in person)  # True
print('tel' in person)   # False
#错误：print(55 in person)   
...
for ch in sentence:
    if 'a'<=ch<='z' or 'A'<=ch<='Z':
        counter[ch]=counter.get(ch,0)+1 #字符第一次出现时，counter 里还没有这个键。
...
stock2={k:v for k,v in stocks.items() if v>100}
print(stock2)